...
dataLayer.push({
  ...
  "detailed_event": "Learning Path Progress",
    "event_data": {
        "learning_path_id": "<learning_path_id>",
        "learning_path_title": "<learning_path_title>",
        "path_progress_percentage": <path_progress_percentage>,
        "topics": "<topics>"
    },
    "user_data": {
        "user_id": "<user_id>"
...
|event_data.path_progress_percentage|number|Captures the percentage of courses completed in a learning path||||||||
